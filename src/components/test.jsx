...
export default class extends Component {
  ...
  handleSubmit = (e) => {
    ...
    axios
      .post("http://140.238.204.76:3001/upload", formData)
      .then((res, err) => {
        if (err) return err;
    ...
    axios
      .post("http://140.238.204.76:3001/upload", formData2)
      .then((res, err) => {
        if (err) return err;
        console.log(JSON.stringify(res.data));
      });
          ...
          <div class="container-login100">
            <div class="wrap-login100">
              ...
              <div class="login100-pic js-tilt" data-tilt>
                ...
                <div>
                  <select
                    defaultValue={this.state.documenttypedata[0]}
                ...
                <div class="wrap-input100 validate-input">
                  ...
                  <input
                    ...
                    name="selected_docimage"
                    placeholder="Select your document file"
                  />
                </div>
                <div class="wrap-input100 validate-input">
                  ...
                  <input
                    ...
                    name="selected_profileimage"
                    placeholder="Select your photo file"
                  />
                </div>
                <div class="wrap-input100 validate-input">
                  <input
              ...
              <form class="login100-form validate-form">
                ...
                <label name="status" value={this.state.error}>
                  {this.state.error}
                </label>
              </form>
            </div>
